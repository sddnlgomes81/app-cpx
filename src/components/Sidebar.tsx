...
export const Sidebar: React.FC = () => {
  const { activeTab, setActiveTab, logout, currentUser, mobileMenuOpen, setMobileMenuOpen } = useApp();
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-slate-900 text-slate-300 flex flex-col shrink-0 border-r border-slate-800 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:h-auto ${
